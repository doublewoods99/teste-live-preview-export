...
export async function exportToPDF(
  ...
  try {
    ...
    // Extract HTML from the preview component with the specified page format (now async)
    const extractedData = await extractPreviewContent(previewElement, options.format || 'A4');
